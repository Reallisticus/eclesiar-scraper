...
const fetchDailyDamage = require('./routes/dailyDamage'); // Add this line
const getDailyDamage = require('./routes/dailyDamage'); // Add this line
const app = express();
...
app.use('/api', fetchDailyDamage);
app.use('/api', getDailyDamage);
